      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-5 flex justify-center order-2 lg:order-1">
            <AboutIllustration className="w-full max-w-md" />
          </div>
          ...
          <div className="lg:col-span-7 space-y-6 order-1 lg:order-2">
            ...
            {/* Core Quote Box */}
            <div className="relative pl-6 py-3 border-l-4 border-indigo-600 bg-white/80 rounded-r-xl shadow-xs">
            ...
            {/* Quick Profile Summary Pills/Grid */}
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
              <div className="flex items-start gap-3 p-3.5 bg-white rounded-xl border border-slate-200/70 shadow-xs">
            ...
            <div className="flex flex-wrap items-center gap-4 pt-4">
              <a
                href="#projects"
                className="px-6 py-3 bg-indigo-600 hover:bg-indigo-700 text-white font-bold text-xs tracking-wider uppercase rounded-lg shadow-md shadow-indigo-600/25 transition-all flex items-center gap-2"
              >
              ...
              <button
                ...
                className="px-6 py-3 border border-slate-300 hover:border-indigo-600 hover:text-indigo-600 text-slate-700 font-bold text-xs tracking-wider uppercase rounded-lg transition-colors flex items-center gap-2 bg-white"
              >
